                                        ...
                                        <div class="info_img">
                                            ...
                                            <div style="width: 50%">
                                                <div class="row_info">
                                                    ...
                                                    <textarea name="edit[diplom_image_app]" id="" cols="30" rows="10"
                                        ...
                                        <div class="info_img">
                                            <div class="row_info_img">
                                                ...
                                                <div class="row_info">
                                                    ...
                                                    <textarea name="edit[type_education_id]" id="" cols="30" rows="10"
                                                ...
                                                <div class="row_info">
                                                    ...
                                                    <textarea name="edit[type_language_id]" id="" cols="30" rows="10"
                                                        class="input_hid"> @if(isset($com_mes['type_language_id'])) {{ $com_mes['type_language_id'] }} @endif </textarea>
                                                </div>
                                                <div class="row_info">
                                                    <h3>@lang('petition.Faculties')</h3>
                                                    <h4> @if ($petition->direction)
                                                        {{ $petition->direction->$name_l }} @else ---------
                                                    @endif <i style="color: #FF5F5F;"
                                                            class="fa fa-exclamation-circle"></i>
                                                    </h4>
                                                    <textarea name="edit[direction_id]" id="" cols="30" rows="10"
                                                        class="input_hid"> @if(isset($com_mes['direction_id'])) {{ $com_mes['direction_id'] }} @endif </textarea>
                                                </div>
                                                <!-- <div class="row_info">
                                                        <h3>Suhbat tili</h3>
                                                        <h4>{{$petition->conversation_language == '1' ? 'O`zbek':''}} {{$petition->conversation_language == '2' ? 'Rus':''}} <i
                                                                    style="color: #FF5F5F;"
                                                                    class="fa fa-exclamation-circle"></i></h4>
                                                ...
                                                <div class="row_info_img img " style="width: 100%">
                                                    @if(mime_content_type(public_path() . '/users/documents/recommendation_images/' . $petition->image_recommendation) == 'application/pdf')
                                                        <iframe id="iframePdf"
                                                            ...
                                                            class="profile-pic6-pdf" src=""></iframe>
                                                        <a
                                                            href="{{ asset('users/documents/recommendation_images') }}/{{ $petition->image_recommendation }}">Yuklab
                                                            olish <i class="fa fa-download"></i></a>
                                                    @else
                                ...
                                <div class="row">
                                    <div class="col-md-6 bor_right">
                                        {{-- <div class="info_img ">--}}
                                            {{-- <div style="width: 50%">--}}
                                                {{-- <div class="row_info">--}}
                                                    {{-- <h4>@lang('petition.Mehnat daftarchasi') <i
                                                            style="color: #FF5F5F;" --}} {{--
                                                            class="fa fa-exclamation-circle"></i>--}}
                                                        {{-- </h4>--}}
                                                ...
                                                {{-- <div class="row_info_img img " style="width: 100%">--}}
                                                    {{--
                                                    @if(mime_content_type(public_path().'/users/documents/workbook/'.$petition->workbook)
                                                    == 'application/pdf')--}}
                                                    {{-- <iframe id="iframePdf" --}} {{--
                                                        style="display: block; width: 100%; height: auto" --}} {{--
                                                        ...
                                                        --}} {{-- class="profile-pic6-pdf" src=""></iframe>--}}
                                                    {{-- <a
                                                        href="{{ asset('users/documents/workbook') }}/{{ $petition->workbook }}">Yuklab--}}
                                                        {{-- olish <i class="fa fa-download"></i></a>--}}
                                                    {{-- @else--}}
                                                    {{-- <img
                                                        src="{{ asset('users/documents/workbook') }}/{{ $petition->workbook }}"
                                            ...
                                            <div class="row_info_img pl-md-3">
                                                <div class="row_info " style="display: flex">
                                                    ...
                                                    <h4>@lang('petition.Passport tarjima') <i style="color: #FF5F5F;"
                                                            class="fa fa-exclamation-circle"></i></h4> &nbsp;&nbsp; <a
                                                        href="{{asset('/users/documents/passport_images')}}/{{$petition->passport_copy_translate}}">
                                                        <i class="fa fa-download"></i> </a>
                                                    <textarea name="edit[passport_copy_translate]" id="" cols="30"
                                                        rows="10"
                                                ...
                                                <div class="row_info " style="display: flex">
                                                    ...
                                                    <h4>@lang('petition.Tugilganlik haqida guvohnoma') <i
                                                            style="color: #FF5F5F;"
                                                            class="fa fa-exclamation-circle"></i></h4> &nbsp;&nbsp; <a
                                                        href="{{asset('/users/documents/passport_images')}}/{{$petition->birth_certificate_copy}}">
                                                        <i class="fa fa-download"></i> </a>
                                                    <textarea name="edit[birth_certificate_copy]" id="" cols="30"
                                                        rows="10"
                                                ...
                                                <div class="row_info " style="display: flex">
                                                    ...
                                                    <h4>@lang('petition.Tugilganlik haqida guvohnoma tarjimasi') <i
                                                            style="color: #FF5F5F;"
                                                            class="fa fa-exclamation-circle"></i></h4> &nbsp;&nbsp; <a
                                                        href="{{asset('/users/documents/passport_images')}}/{{$petition->birth_certificate_copy_translate}}">
                                                        <i class="fa fa-download"></i> </a>
                                                    <textarea name="edit[birth_certificate_copy_translate]" id=""
                                                        cols="30" rows="10"
                                    ...
                                    <div class="col-md-6">
                                        <div class="info_img">
                                            <div class="row_info_img">
                                                <div class="row_info " style="display: flex">
                                                    <h4>@lang('petition.Talim haqida hujjat tarjima') <i
                                                            style="color: #FF5F5F;"
                                                            class="fa fa-exclamation-circle"></i></h4> &nbsp;&nbsp; <a
                                                        href="{{asset('/users/documents/diplom_images')}}/{{$petition->edu_document_copy_translate}}">
                                                        <i class="fa fa-download"></i> </a>
                                                    <textarea name="edit[edu_document_copy_translate]" id="" cols="30"
                                                        rows="10"
                                                ...
                                                <div class="row_info " style="display: flex">
                                                    <h4>@lang('petition.086 tibbiyot malumotnomasi') <i
                                                            style="color: #FF5F5F;"
                                                            class="fa fa-exclamation-circle"></i></h4> &nbsp;&nbsp; <a
                                                        href="{{asset('/users/documents/med_forms')}}/{{$petition->med_form_copy_086}}">
                                                        <i class="fa fa-download"></i> </a>
                                                ...
                                                <div class="row_info " style="display: flex">
                                                    <h4>@lang('petition.086 tibbiyot malumotnomasi tarjima') <i
                                                            style="color: #FF5F5F;"
                                                            class="fa fa-exclamation-circle"></i></h4> &nbsp;&nbsp; <a
                                                        href="{{asset('/users/documents/med_forms')}}/{{$petition->med_form_copy_086_translate}}">
                                                        <i class="fa fa-download"></i> </a>
                                                    <textarea name="edit[med_form_copy_086_translate]" id="" cols="30"
                                                        rows="10"
                                            ...
                                            <div style="width: 50%; border-left: 1px solid #ABABAB">
                                                <div class="row_info " style="display: flex">
                                                    <h4>@lang('petition.OIV infektsiyasi yo`qligi to`g`risidagi guvohnoma')
                                                        <i style="color: #FF5F5F;" class="fa fa-exclamation-circle"></i>
                                                    </h4> &nbsp;&nbsp; <a
                                                        href="{{asset('/users/documents/med_forms')}}/{{$petition->vich_copy}}">
                                                        <i class="fa fa-download"></i> </a>
                                                ...
                                                <hr>
                                                <div class="row_info " style="display: flex">
                                                    <h4>@lang('petition.OIV infektsiyasi yo`qligi to`g`risidagi guvohnoma tarjima')
                                                        <i style="color: #FF5F5F;" class="fa fa-exclamation-circle"></i>
                                                    </h4> &nbsp;&nbsp; <a
                                                        href="{{asset('/users/documents/med_forms')}}/{{$petition->vich_copy_translate}}">
                                                        <i class="fa fa-download"></i> </a>
                                                ...
                                                <div class="row_info " style="display: flex">
                                                    <h4>@lang('petition.063 tibbiyot malumotnomasi') <i
                                                            style="color: #FF5F5F;"
                                                            class="fa fa-exclamation-circle"></i></h4> &nbsp;&nbsp; <a
                                                        href="{{asset('/users/documents/med_forms')}}/{{$petition->med_form_copy_063}}">
                                                        <i class="fa fa-download"></i> </a>
                                                ...
                                                <div class="row_info " style="display: flex">
                                                    <h4>@lang('petition.063 tibbiyot malumotnomasi tarjima') <i
                                                            style="color: #FF5F5F;"
                                                            class="fa fa-exclamation-circle"></i></h4> &nbsp;&nbsp; <a
                                                        href="{{asset('/users/documents/med_forms')}}/{{$petition->med_form_copy_063_translate}}">
                                                        <i class="fa fa-download"></i> </a>
                                                    <textarea name="edit[med_form_copy_063_translate]" id="" cols="30"
                                                        rows="10"
